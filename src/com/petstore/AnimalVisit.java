...
class Dog extends Animal {
    ...
    public  LocalDate getAnimalChipDate() {
        System.out.println("child getChildChipDate");
        return Animal.chipDate;
    }
...
public class AnimalVisit {
    public static void main(String[] args) {
        ...
        Animal a = pug;
        System.out.println("Chip Date Animal = " + a.getChipDate());

        // Call the supplemented method
        System.out.println("Chip Date = " + pug.getAnimalChipDate());
